...
async function migrateButtonComponents() {
  try {
    ...
    // Use both snake_case and camelCase field names
    const components = [
      {
        id: burgerButtonId,
        ...
        preview_image: "https://via.placeholder.com/300x200/3498db/ffffff?text=Burger+Menu",
      ...
      },
      {
        ...
        preview_image: "https://via.placeholder.com/300x200/e74c3c/ffffff?text=Stop+Motion",
