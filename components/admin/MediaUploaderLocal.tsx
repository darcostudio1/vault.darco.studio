...
import { getMediaType, ensureDirectoriesExist } from '../../lib/localFileStorage';
...
const MediaUploader: React.FC<MediaUploaderProps> = ({
  ...
  // Ensure directories exist on mount
  useEffect(() => {
  ...
  const uploadFile = async (file: File) => {
    ...
    try {
      ...
      onMediaChange(data.url, data.mediaType);
  ...
  return (
    <div className="space-y-4">
      ...
      {showUrlInput && (
        <form onSubmit={handleUrlSubmit} className="mt-4 space-y-2">
          <Input
            type="url"
            value={urlInput}
