    ...
    const fetchComponent = async () => {
      try {
        ...
        if (comp) {
          ...
          const newMediaType = comp.mediaType === 'video' ? 'video' : 
                             comp.mediaType === 'image' ? 'image' : 
                             'unknown';
    ...
    try {
      ...
      const updatedComponent: Component = {
        ...
        content: {
          ...
          external_scripts: externalScripts || '' // For backward compatibility
        },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <MediaUploader
                      ...
                      onMediaChange={(url, type) => {
                        setPreviewImage(url);
                        if (type === 'image') setMediaType('image');
                      }}
                  ...
                  <div className="space-y-2">
                    ...
                    <MediaUploader
                      ...
                      onMediaChange={(url, type) => {
                        setPreviewVideo(url);
                        if (type === 'video') setMediaType('video');
                      }}
                      componentId={id as string}
