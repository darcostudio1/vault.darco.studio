...
import MediaUploader from '../../../components/admin/MediaUploaderLocal';
import { ensureDirectoriesExist } from '../../../lib/localFileStorage';
...
const EditComponentPage: React.FC = () => {
  ...
  // Ensure directories exist on component mount
  useEffect(() => {
